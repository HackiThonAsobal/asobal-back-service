...
public class JWTAuthorizationFilter extends OncePerRequestFilter {
    ...
    private final String SECRET = "lapassdeciscoquenoquieredeciraasobalporqueesungurudelaseguridadinformatica*64?.empty";
    ...
    private void setUpSpringAuthentication(Claims claims) {
        ...
        authorities.add((String) claims.get("email"));
